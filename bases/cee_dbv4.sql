...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-10-2024 a las 23:43:21
...
INSERT INTO `exam_tbl` (`ex_id`, `cou_id`, `ex_title`, `ex_time_limit`, `ex_description`, `ex_created`) VALUES
(12, 26, 'BASE DE DATOS', '1', 'Responder las preguntas con los conocimientos aprendidos', '2024-09-20 23:22:12'),
(24, 67, 'ATAQUES DE PHISING', '10', 'Demostrar los conocimientos aprendidos en la unidad 1 de seguridad informática', '2024-09-20 20:54:10'),
(25, 67, 'Diagnostico', '60', 'Primer examen de revision ', '2024-10-03 06:24:20');
...
--
ALTER TABLE `exam_tbl`
  MODIFY `ex_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
