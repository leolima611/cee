...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-10-2024 a las 08:47:14
...
(12, 26, 'BASE DE DATOS', '1', 'Responder las preguntas con los conocimientos aprendidos', '2024-10-03 23:36:23', 3),
...
(15, 67, 'Introducción', 1, NULL, NULL, 1),
...
--
ALTER TABLE `acti_tipes`
  MODIFY `idacti_tipes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `rel_topic`
  MODIFY `idrel_topic` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `topic_cou`
  MODIFY `idtopic_cou` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
