                              ...
                              <?php 
								...
								if (empty($files)) {
									...
									foreach ($files as $file) {
										$selExmne = $conn->query("SELECT * FROM topic_cou WHERE acti_tipes = 2 AND
										valor = '$file'");
										...
										<tr>
                                           ...
                                           <td>
											   ...
											   ?>
											   <a type="button" id="deleteFile" data-file="<?php echo $file ?>"  class="btn btn-danger btn-sm">Eliminar</a>
											   <?php
												}
											   ?>
                                           </td>
